...
操作手册已同步到 2026-09-07：[使用手册](doc/手册/标贝音频采集_使用手册.pdf)与[详细操作手册](output/pdf/标贝音频采集_详细操作手册_2026-09-07.pdf)包含人声幅值检查、短句自动结束、人工保留、设置生效范围及授权异常封存说明。手册源码与截图复现步骤见 [手册维护说明](doc/手册/README.md)。
